...
from .detr_modules.detr import DETR, SetCriterion
from .detr_modules.matcher import HungarianMatcher
from .detr_modules.position_encoding import PositionEmbeddingSine
from .detr_modules.transformer import Transformer
from .detr_modules.segmentation import DETRsegm, PostProcessPanoptic, PostProcessSegm
from utils.box_ops import box_cxcywh_to_xyxy, box_xyxy_to_cxcywh
from utils.fb_misc import NestedTensor
...
class Detr(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        pixel_mean = torch.Tensor(cfg.MODEL.PIXEL_MEAN).to(self.device).view(channels, 1, 1)
        pixel_std = torch.Tensor(cfg.MODEL.PIXEL_STD).to(self.device).view(channels, 1, 1)
